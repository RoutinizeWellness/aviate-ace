-- Create comprehensive data setup for aviation training platform (corrected enum values)
...
VALUES 
  ('A320 Ground School', 'Comprehensive ground training for A320 aircraft systems', 'airbus_a320', 'intermediate', 40, true),
  ('A320 Advanced Systems', 'Advanced A320 systems training including ECAM procedures', 'airbus_a320', 'advanced', 30, true),
  ('B737 Ground School', 'Comprehensive ground training for B737 aircraft systems', 'boeing_737', 'intermediate', 35, true),
  ('B737 MAX Differences', 'B737 MAX specific training and differences course', 'boeing_737', 'advanced', 20, true)
